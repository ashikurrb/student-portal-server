...
import { isAdmin, requireSignIn,isModerator } from '../middlewares/authMiddleware.js'
...
//create grade
router.post('/create-grade', requireSignIn, isModerator, formidable(), createGradeController)
